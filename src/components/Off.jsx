...
const Off = () => {
  return (
    <section id="Off" className="bg-primary-50 mt-20">
      <div className="my-container">
        ...
        <div className="flex justify-between items-center gap-5 pb-8 mt-5">
          ...
          <div className="flex flex-col items-center bg-white w-fit rounded-2xl">
            <img src="/img/off/1.png" className="rounded-t-2xl" alt="" />
          ...
          <div className="flex flex-col items-center bg-white w-fit rounded-2xl">
            <img src="/img/off/2.png" className="rounded-t-2xl" alt="" />
            <div className="flex flex-col justify-start items-start w-full p-6">
              <p className="text-secondary-900 font-semibold mb-3">
                ست نایک مدل S-2000
              </p>
          ...
          <div className="hidden md:flex flex-col items-center bg-white w-fit rounded-2xl">
            <img src="/img/off/3.png" className="rounded-t-2xl" alt="" />
            <div className="flex flex-col justify-start items-start w-full p-6">
              <p className="text-secondary-900 font-semibold mb-3">
                کفش نایک مدل S-2000
              </p>
